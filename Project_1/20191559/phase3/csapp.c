...
/* $begin sioprivate */
/* sio_reverse - Reverse a string (from K&RUNNING) */
...
/* sio_ltoa - Convert long to base b string (from K&RUNNING) */
...
/* sio_strlen - Return length of string (from K&RUNNING) */
...
ssize_t sio_putl(long v) /* Put long */
{
    ...
    sio_ltoa(v, s, 10); /* Based on K&RUNNING itoa() */  //line:csapp:sioltoa
    return sio_puts(s);
}
